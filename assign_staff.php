<?php
    ...
    if(isset($_POST['assignStaff'])){
        ...
        $deletekoordinator = $AssignStaffDN->deletesemua($id);
            ...
            foreach ($nama as $k) {
                ...
                if(!in_array($k, $existingStaffId)){
                    ...
                    if($k==$status_kordinator){
                        ...
                        $cek = $AssignStaffDN->CekKordinator($nama_kegiatan);

                            if($cek->num_rows==0){

                                $AssignStaffDN-> Create($k, 'Y',  $nama_kegiatan,  $tgl_mulai, $tgl_selesai);

                            }

                    }else{

                        $AssignStaffDN-> Create($k, 'N',  $nama_kegiatan,  $tgl_mulai, $tgl_selesai);
                                    ...
                                    <div class="dataTable_wrapper">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">                                   
                                            ...
                                            <tbody>
                                                ...
                                                <tr><th>Nama Kegiatan</th><td><?php echo $data['nama_kegiatan']?></td></tr>

                                                <tr><th>Provinsi</th><td><?php echo $data['provinsi']?></td></tr>

                                                <tr><th>Kabupaten/Kota</th><td><?php echo $data['kabkot']?></td></tr>

                                                <tr><th>Tempat</th><td><?php echo $data['tempat_kegiatan']?></td></tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> 
                                                        ...
                                                        <a href="monitoring.php?active=<?php echo base64_encode(1);?>" class="btn btn-danger" role="button">Cancel</a>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $("#buttonModal").click(function(){
                    ...
                    document.location.href='monitoring.php?active=<?php echo base64_encode(1);?>';
